...
// propose-playdate, etc.) keeps today's narrow, centered mobile column at
// any window width, since it was never designed to stretch wider.
// useSegments() (not usePathname()) on purpose — segments
